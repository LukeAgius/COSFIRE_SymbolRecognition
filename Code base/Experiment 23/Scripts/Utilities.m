classdef Utilities
    methods(Static)
        ...
        function result = getTestingDirectory(params)
             if strcmp(params.OS,'WIN') == 1
                result = strcat(params.WIN.DataSetsPath,params.TestingFolder,'/',params.TestingFolder,'/');
            else
                result = strcat(params.OSX.DataSetsPath,params.TestingFolder,'/',params.TestingFolder,'/');
            end
        end
